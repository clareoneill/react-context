/*
 This optional code is used to register a service worker. The register() function is not called by default.
...
export function register(config) {
  if (process.env.NODE_ENV === 'production' && 'serviceWorker' in navigator) {
    ...
    if (publicUrl.origin !== window.location.origin) {
      ...
      This might happen if a CDN (Content Delivery Network) is used to serve assets; see https://github.com/facebook/create-react-app/issues/2374
      */
      return;
    }
    ...
    window.addEventListener('load', () => {
      ...
      if (isLocalhost) {
        ...
        // Add some additional logging to localhost, pointing developers to the service worker/PWA (Progressive Web App) documentation.
